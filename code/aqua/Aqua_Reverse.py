...
def process_question(entry):
    ...
    options_str = "\n".join([f"{option}" for option in opinions])
    question = f"{question}\nOptions:\n{options_str}"   
    ...
    try:
        ...
        while try_num < max_try:
            if try_num == 0:
                ...
                model_input = f"Here is a multiple-choice question about mathematics. Please reason through it step by step, and at the end, provide your answer option with 'Therefore, the correct answer is option X', Where 'X' is the correct option you think from A,B,C,D,E. Here is the question you need to answer:\n{question}\nLet's think step by step:"
...
def process_directory(directory):
    ...
    while count < 1:
        for i in range(6):
            ...
            output_file = f"Aqua_Reverse_{MODEL_NAME}_aqua_results_{n}-{m}.json"
            ...
            evaluator.save_statistics(filename=f"Aquq_Reverse_{MODEL_NAME}_statistics_{n}-{m}.csv")
