...
def process_directory(directory):
    ...
    while count < 1:
        for i in range(3):
            ...
            output_file = f"Forward_{directory}_{MODEL_NAME}_mathbench_{n}-{m}.json"
            ...
            evaluator.save_statistics(filename=f"Forward_{directory}_{MODEL_NAME}_mathbench_statistics_{n}-{m}.csv")
